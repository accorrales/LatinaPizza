...
<div class="container mx-auto py-6">
    ...
    <form action="{{ route('admin.productos.store') }}" method="POST" class="space-y-4" data-show-loading>
        @csrf
        ...
        <div class="pt-4">
            <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded">{{ __('viewAdmin/productos_admin.create.guardar') }}</button>
        </div>
    </form>
</div>
@endsection
