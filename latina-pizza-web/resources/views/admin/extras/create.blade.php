    ...
    <form method="POST" action="{{ route('admin.extras.store') }}" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}"
                class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500 @error('nombre') border-red-500 @enderror" required>
            @error('nombre')
