...
<div class="max-w-3xl mx-auto p-6 bg-white rounded-xl shadow-md mt-8">
    <h2 class="text-3xl font-extrabold mb-6 text-center text-blue-600">
        {{ __('viewAdmin/extras_admin.titulo_editar') }}
    </h2>
    ...
    <form id="formCrearTamano" method="POST" action="{{ route('admin.extras.update', $extra->id) }}" class="space-y-6">
        ...
        <div>
            ...
            <input
                ...
                name="nombre"
                id="nombre"
                value="{{ old('nombre', $extra->nombre) }}"
                class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('nombre') border-red-500 @enderror"
                required
            >
            @error('nombre')
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
                ...
                <input
                    type="number" step="0.01" name="precio_pequena"
                    value="{{ old('precio_pequena', $extra->precio_pequena) }}"
            ...
            <div>
                ...
                <input
                    type="number" step="0.01" name="precio_mediana"
                    value="{{ old('precio_mediana', $extra->precio_mediana) }}"
            ...
            <div>
                ...
                <input
                    type="number" step="0.01" name="precio_grande"
                    value="{{ old('precio_grande', $extra->precio_grande) }}"
            ...
            <div>
                ...
                <input
                    type="number" step="0.01" name="precio_extragrande"
                    value="{{ old('precio_extragrande', $extra->precio_extragrande) }}"
        ...
        <div class="flex justify-between mt-6">
            <a href="{{ route('admin.extras.index') }}"
               ...
               class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded shadow">
                {{ __('viewAdmin/extras_admin.cancelar') }}
            </a>
            <button type="submit" onclick="return validarYMostrarLoading('formCrearTamano')"
                ...
                <i class="fas fa-sync-alt mr-2"></i> {{ __('viewAdmin/extras_admin.actualizar') }}
            </button>
        </div>
    </form>
</div>
